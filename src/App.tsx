...
const img = {
  ...
  porknood: 'https://images.pexels.com/photos/884600/pexels-photo-884600.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  spicynood: 'https://images.pexels.com/photos/1279330/pexels-photo-1279330.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',

  // Rice
  rice: 'https://images.pexels.com/photos/28503589/pexels-photo-28503589.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  friedrice: 'https://images.pexels.com/photos/3926123/pexels-photo-3926123.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  lamb: 'https://images.pexels.com/photos/6210876/pexels-photo-6210876.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  sweetpork: 'https://images.pexels.com/photos/539451/pexels-photo-539451.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  crispypork: 'https://images.pexels.com/photos/410648/pexels-photo-410648.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  cauliflower: 'https://images.pexels.com/photos/725991/pexels-photo-725991.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  chicken: 'https://images.pexels.com/photos/233305/pexels-photo-233305.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  seafoodpot: 'https://images.pexels.com/photos/699953/pexels-photo-699953.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  chocomilkshake: 'https://images.pexels.com/photos/103566/pexels-photo-103566.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  hotlemon: 'https://images.pexels.com/photos/1414110/pexels-photo-1414110.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  beer: '/menu/gorkhastrong250.jpg',
  pilsner: 'https://images.pexels.com/photos/1552630/pexels-photo-1552630.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  craftbeer: 'https://images.pexels.com/photos/1267682/pexels-photo-1267682.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
...
const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      item('Gorkha Pilsner (650ml)', 590, 'A clean, golden pour with a soft, bready finish.', img.pilsner),
      item('Gorkha Craft (250ml)', 620, 'Small-batch character with a confident hop bite.', img.craftbeer),
      item('Turbo (650ml)', 650, 'Full-bodied and strong, built for long evenings.', img.pilsner),
      item('Glacier (650ml)', 720, 'Smooth, chilled and effortlessly refreshing.', img.craftbeer),
    ],
  },
  {
    name: 'Milkshakes & Lassi',
    items: [
      item('Chocolate Milkshake', 370, 'Silken, chilled and made to order.', img.chocomilkshake),
      ...
      item('Oreo Milkshake', 380, 'Crushed cookies folded through thick cream.', img.chocomilkshake),
  ...
  },
  {
    ...
    items: [
      ...
      item('Lemon Tea', 115, 'Bright, citrus-laced and restorative.', img.hotlemon),
  ...
  },
  {
    ...
    items: [
      ...
      item('Sprite', 145, 'Crisp, lemon-lime and ice-cold.', img.lemonade),
  ...
  },
  {
    name: 'Special Drinks',
    items: [
      item('Hot Lemon', 275, 'Bright, layered and finished with seasonal detail.', img.hotlemon),
      item('Hot Lemon Honey Ginger', 285, 'Soothing, warming and deeply restorative.', img.hotlemon),
      item('Hot Chocolate', 350, 'Rich, dark and poured like velvet.', img.chocomilkshake),
      ...
      item('Coconut Kiss', 350, 'Creamy, tropical and softly sweet.', img.milkshake),
  ...
  },
  {
    ...
    items: [
      ...
      item('Pork Noodles', 599, 'Rich pork and noodles in a deeply savoury sauce.', img.porknood),
      item('Spicy Noodles', 450, 'Chilli-laced noodles with a lingering warmth.', img.spicynood),
      item('Spicy Pork Noodles', 500, 'Pork, heat and texture in every bite.', img.spicynood),
  ...
  },
  {
    ...
    items: [
      ...
      item('Egg Fried Rice', 250, 'Wok-charred rice folded with golden egg.', img.friedrice),
      item('Egg Fried Rice with Beef', 780, 'Hearty, beef-rich and deeply savoury.', img.friedrice),
      item('Chicken Rice Bowl', 700, 'A generous bowl built for one.', img.rice),
      item('Lamb Rice Bowl', 790, 'Tender lamb over fragrant rice.', img.lamb),
  ...
  },
  {
    ...
    items: [
      ...
      item('Dry Fried Cauliflower with Pork', 750, 'Charred florets and pork in a dry, spicy glaze.', img.cauliflower),
      ...
      item('Spicy Lamb', 890, 'Cumin, chilli and tender lamb in a dry rub.', img.lamb),
      ...
      item('Sweet & Sour Pork Ribs', 780, 'Glossy ribs with a tangy-sweet lacquer.', img.sweetpork),
      item('Mushroom Chicken', 850, 'Earthy mushrooms and tender chicken.', img.mushroom),
      item('Spicy Chicken', 700, 'Dry-fried chicken with chilli and Sichuan pepper.', img.chicken),
      ...
      item('Seared Chicken', 700, 'Clean, golden-seared chicken with a light sauce.', img.chicken),
  ...
  },
  {
    ...
    items: [
      ...
      item('Deluxe Seafood Platter', 7880, 'The grandest expression of our kitchen.', img.seafoodpot),
    ],
  },
];
